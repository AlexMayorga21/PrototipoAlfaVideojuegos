...
public class GameManager extends GameCore {
    ...
    public void init() {
        ...
        // load sounds
        soundManager = new SoundManager(PLAYBACK_FORMAT,10);
        prizeSound = soundManager.getSound("sounds/YeahScience.wav");
        boopSound = soundManager.getSound("sounds/YeahScience.wav");
